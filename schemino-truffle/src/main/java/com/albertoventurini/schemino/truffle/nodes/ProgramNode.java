...
import com.albertoventurini.schemino.truffle.nodes.builtin.AddNode;
import com.albertoventurini.schemino.truffle.nodes.builtin.IfNode;
...
public class ProgramNode extends ExpressionNode {
    ...
    private void installBuiltIns(VirtualFrame frame) {
        ...
        ScheminoFunction ifFunction = new ScheminoFunction(new EvalRootNode(language, new IfNode()));
        final FrameSlot slot2 = frame.getFrameDescriptor().addFrameSlot("if", FrameSlotKind.Object);
        frame.setObject(slot2, ifFunction);
