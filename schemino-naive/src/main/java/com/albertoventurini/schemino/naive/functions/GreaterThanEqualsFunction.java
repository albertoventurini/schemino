...
/**
 * A built-in function that checks if the first argument is greater than the second argument.
 */
public class GreaterThanEqualsFunction implements ScheminoFunction {
